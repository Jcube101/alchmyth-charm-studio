...
function DesignSubmission({ files, setFiles, description, setDescription, error, compact = false }: { files: File[]; setFiles: (files: File[]) => void; description?: string; setDescription?: (value: string) => void; error?: string; compact?: boolean }) {
